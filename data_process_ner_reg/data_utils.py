...
#     '''
    ...
    # print(df['e1'].head(20))
    # print(df['e2'].head(20))
    # print(df['sentence'].head(20))

    vocabulary2id_saved_path='../open_data/vocabulary2id.pkl'



    # for each_line in df['sentence']:
    #     token_sentence=basic_tokenizer(each_line)
    #     print(token_sentence)
    create_vocabulary(vocabulary2id_saved_path, df, max_vocabulary_size=50000,
                      tokenizer=None, normalize_digits=False)
